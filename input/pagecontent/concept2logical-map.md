...
<div style="margin-top: 2rem; margin-bottom: 3rem;">
  <figure>
    <p></p>
    <img width="40%" alt="Patient information mapped to the logical model" src="concept2logical-1.png"/>
...
<div style="margin-top: 2rem; margin-bottom: 3rem;">
  <figure>
    <p></p>
    <img width="40%" alt="Condition addressed by the care plan mapped to the logical model" src="concept2logical-2.png"/>
...
<div style="margin-top: 2rem; margin-bottom: 3rem;">
  <figure>
    <p></p>
    <img width="40%" alt="Care Plan goal information mapped to the logical model" src="concept2logical-3.png"/>
...
<div style="margin-top: 2rem; margin-bottom: 3rem;">
  <figure>
    <p></p>
    <img width="40%" alt="Care Plan activity information mapped to the logical model" src="concept2logical-4.png"/>
